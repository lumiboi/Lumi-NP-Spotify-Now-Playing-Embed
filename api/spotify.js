...
const generateSVG = (track, isPlaying) => {
    const title = track?.name || 'Not Playing';
    const artist = track?.artists?.map(a => a.name).join(', ') || 'Spotify';
    ...
    <svg width="400" height="130" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <rect width="400" height="130" rx="15" fill="url(#bgGradient)"/>
        ...
        <rect x="15" y="15" width="100" height="100" rx="10" fill="#282828"/>
        <text x="65" y="70" text-anchor="middle" fill="#1DB954" font-size="40">♪</text>
        `}
        
        <g transform="translate(130, 0)">
            <text x="0" y="40" fill="#ffffff" font-family="'Segoe UI', Arial, sans-serif" font-size="16" font-weight="600">
                ${displayTitle}
            </text>
            <text x="0" y="62" fill="#b3b3b3" font-family="'Segoe UI', Arial, sans-serif" font-size="13">
                ${displayArtist}
            </text>
            ...
            <g transform="translate(0, 80)">
                ...
                <text x="16" y="10" fill="#1DB954" font-family="'Segoe UI', Arial, sans-serif" font-size="11">Now Playing</text>
                ` : `
                <circle cx="6" cy="6" r="4" fill="#b3b3b3"/>
                <text x="16" y="10" fill="#b3b3b3" font-family="'Segoe UI', Arial, sans-serif" font-size="11">Recently Played</text>
                `}
            </g>
        </g>
